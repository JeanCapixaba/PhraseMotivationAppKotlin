...
class Mock {
    ...
    private val all = MotivationConstantes.NUMBERS.ALL
    private val happy = MotivationConstantes.NUMBERS.EMOJI
    private val sunny = MotivationConstantes.NUMBERS.SUNNY
    ...
    fun getPhrase(value: Int) : String {
        ...
        val filtred = listPhrases.filter { it.category == value  || value == 1}
